...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { description: @portfolio.description, image: @portfolio.image, projectname: @portfolio.projectname }
    end
  ...
  test "should update portfolio" do
    put :update, id: @portfolio, portfolio: { description: @portfolio.description, image: @portfolio.image, projectname: @portfolio.projectname }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
